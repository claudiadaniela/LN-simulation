...
public class NetworkTopology {
	...
	private KShortestPathsAlgorithmInterface kPathsAlg;
	...
	public NetworkTopology() {
		...
		this.kPathsAlg = new JGraphtKShortestPaths();
	}
	...
	public List<GraphPath<LNVertex, LNEdge>> findShortestPaths(LNVertex id1, LNVertex id2,
		...
		return kPathsAlg.findShortestPaths(networkGraph, id1, id2, validator);
	}
	...
	public boolean sendTransfer(Transfer transfer) {
		...
		List<GraphPath<LNVertex, LNEdge>> paths = findShortestPaths(transfer.getSource(), transfer.getRecipient(),
				new LNPathValidator(transfer.getAmount()));
	...
	/**
	 * TODO: sync mechanisms Refund with the total amount on each hop. During
	 * the transfer , the actual amount sent on edges will be smaller, depending
	 * on the fee of the hops it passes through.
	 */
